...
public class GPSTracker extends Service implements LocationListener {
     ...
     * On pressing FragmentSettings button will lauch FragmentSettings Options
     */
    public void showSettingsAlert() {
        ...
        // On pressing FragmentSettings button
        alertDialog.setPositiveButton("FragmentSettings", new DialogInterface.OnClickListener() {
