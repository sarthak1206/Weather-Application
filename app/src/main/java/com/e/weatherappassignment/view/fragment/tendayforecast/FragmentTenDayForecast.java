package com.e.weatherappassignment.view.fragment.tendayforecast;
...
import com.e.weatherappassignment.view.fragment.tendaylocationweather.FragmentWeather;
...
public class FragmentTenDayForecast extends BaseFragment implements FavouriteRepository.FetchSavedListInterface {
    ...
    ViewPager viewpager;
    private TenDayForecastViewPagerAdapter viewPagerAdapter;
    ...
    private void setupViewPager(ViewPager viewPager) {
        viewPagerAdapter = new TenDayForecastViewPagerAdapter(getChildFragmentManager());
